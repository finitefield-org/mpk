...
internal static class CSharpPracticalDataTypes
{
    ...
    internal static PracticalDataTypes Validate(PracticalSourceSelection selection,
        ...
        bool allowStructuralEquality = false, bool allowArrayConstruction = false, bool allowLoopControl = false, bool allowPatternControl = false, bool allowExceptionControl = false, bool allowHandlers = false)
    {
        try
        {
            ...
            PracticalNormalizedSyntax syntax = CSharpPracticalSyntaxNormalizer.Normalize(
                ...
                validateConstruction is null ? null :
                    (current, closure) => validateConstruction(current, closure, model.GetTypes()), allowLoopControl, allowPatternControl, allowExceptionControl, allowHandlers);
