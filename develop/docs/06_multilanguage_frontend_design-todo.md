...
`CSHARP-03-T01-W01/W02/W03/W04/W05/W06` completed the entry audit, consumer
...
async-rejection measurements without adding a practical-profile identity or
production path; T01-W07 is ready and all later items remain serially
blocked.
...
inventory, private frontend/toolchain closure proof, and Roslyn data,
construction, control, exception, pattern, dependency, generic, iterator, and
async-rejection measurements; T01-W07 is ready, and later phases remain
serially blocked.
...
inventory, private frontend/toolchain closure proof, and Roslyn data,
construction, control, exception, pattern, dependency, generic, iterator, and
async-rejection measurements, `CSHARP-03-T01-W07` is ready, and each later
`Wnn` item remains blocked until its serial predecessor and task-local gate are
complete.
