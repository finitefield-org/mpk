...
Status: staged post-VIR-cutover replacement

Last reviewed: 2026-08-22

This document is the user-facing design that replaces the active Vertex AI
assistant document during `GO-VIR-02-T12`. Until that atomic cutover, the
released `mpk explain` command and the active document remain on their
