...
observations and 13,576 new entry observations, totaling 52,526. Original W04
...
and [node-entry review](../verification-logs/control-edges/node-entry/review.md).
...
observation mapping, non-transfer memory effects, source-exit production,
