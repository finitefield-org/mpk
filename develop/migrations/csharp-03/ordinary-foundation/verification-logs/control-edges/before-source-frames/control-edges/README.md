...
observations, totaling 73,137. Original W04 binding comparisons cover 95 identities in the initial partition and 36 in the
...
and [count/fill control review](../verification-logs/control-edges/factored-entry/review.md).
...
complete loop execution, framing and invariants remain open.
