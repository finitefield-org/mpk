...
The W04 loop/pattern subset contains 106 data operations: 98 defined normal
relations and eight pending Option/compound operations. One non-data invocation
...
observations, 10,608 source-frame observations and 616 native-operation
observations, totaling 84,361. Original W04
...
and [native-operation review](../verification-logs/control-edges/native-operations/review.md).
