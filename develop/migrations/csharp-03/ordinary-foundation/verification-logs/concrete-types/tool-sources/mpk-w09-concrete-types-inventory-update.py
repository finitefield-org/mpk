...
paths=sorted(set(paths));new='crates/mpk-vc/tests/support/csharp_practical_ordinary_concrete_type_tests.rs';assert new in paths
...
p=Path('crates/mpk-vc/tests/csharp_practical_inventory.rs');assert t.count('4_967,')==1;p.write_text(t.replace('4_967,','4_968,'))
print('Exact previous144-path preimage preserved;added only',new,';namespace paths',len(paths),'total4968')
