...
repo=Path('/Users/kazuyoshitoshiya/mpk');root=repo/'develop/migrations/csharp-03/ordinary-foundation';e=root/'verification-logs/concrete-operations';mode=sys.argv[1];path=e/(mode+'.json')
