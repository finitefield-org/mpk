...
W08 paired command/context `CanonicalFieldEncodingsEqual` relation. Fourteen
isolated member mutations are detected in 158 ordinary observations.
...
relations while its application proof remains pending. All other W08 constants
remain explicitly unresolved, including admission, lookup, history and replay.
No complete application certificate is asserted. See
