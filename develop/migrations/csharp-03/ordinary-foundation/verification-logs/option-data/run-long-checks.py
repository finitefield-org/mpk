"""Run only the outstanding option-data runtime partition; completed checks are excluded."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    if args.output:
        ...
        output = Path(tempfile.mkdtemp(prefix="mpk-w09-option-data-long-", dir="/tmp"))
