Superseded by [the proof-observation correction](unit-4-binding-observation-review.md).
The prior direct review missed the proof-level IEEE comparison mismatch.
