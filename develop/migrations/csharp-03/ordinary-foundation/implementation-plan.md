...
local checks. Unit 2 has Boolean/integer and Time/Duration/Instant implementation
increments, documented in `unit-2-progress.md`; its other scalar categories and
