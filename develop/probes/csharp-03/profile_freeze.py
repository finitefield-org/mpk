...
def schema_type_system() -> dict:
    ...
    records = [
        ...
        nested_record("boundary_field", [
            ...
            ("codec_parameters", "codec_parameters_or_null")]),
        nested_record("codec_parameters", [
            ("scale", "codec_scale_or_null"), ("rounding", "codec_rounding_or_null")]),
    ...
    record_producers = {
        ...
        "codec_parameters": "CSHARP-03-T03-W14",
    ...
    return {
        "atoms": {
            ...
            "registered_codec_mode_id": "the exact string canonical; scale and rounding come only from codec_parameters",
            "codec_parameters_or_null": "JSON null exactly when the adjacent codec_id is null; otherwise the strict codec_parameters record",
            "codec_scale_or_null": "JSON null or canonical JSON integer in 0..28",
            "codec_rounding_or_null": "JSON null or exactly ToEven, AwayFromZero, ToZero, ToNegativeInfinity, ToPositiveInfinity",
...
def expression_union() -> dict:
    ...
    fields = {
        ...
        "codec_parse": [("codec_id", "registered_codec_id"), ("codec_parameters", "codec_parameters"), ("text", expression)],
        "codec_format": [("codec_id", "registered_codec_id"), ("codec_parameters", "codec_parameters"), ("value", expression),
...
def make_freeze() -> dict:
    ...
    result = {
        ...
        "amendments": [{
            ...
            "date": "2026-09-06",
            "previous_freeze_content_sha256": "b1dc1c9c1b6124410965c0a1763b9cedc902eadee221058aa093a95f2d7000b5",
            "previous_publication_raw_sha256": "dd3b45276d91086b62dce8757cef4f79e16fe1dedcfce398af0ff979ad2489ac",
            "owner": "CSHARP-03-T03-W14",
