...
DOMAIN_INPUTS_PATH = REPOSITORY_ROOT / "develop/migrations/csharp-03/domain/domain-inputs.json"
...
def validate_domain_inputs_value(value: object) -> dict[str, object]:
    manifest = active.exact_keys(value, {"files", "schema", "work_item"})
    if (
        active.text(manifest["schema"]) != DOMAIN_INPUTS_SCHEMA
        or active.text(manifest["work_item"]) != "CSHARP-03-T03-W12"
    ):
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_DOMAIN_INPUTS")
    records = active.array(manifest["files"])
    expected_paths = [
        "crates/mpk-cli/tests/csharp_practical_domain_harness.cs",
        "csharp-tools/csharp2vir/PracticalArrays.cs",
        "csharp-tools/csharp2vir/PracticalCapture.cs",
        "csharp-tools/csharp2vir/PracticalConstruction.cs",
        "csharp-tools/csharp2vir/PracticalDataTypes.cs",
        "csharp-tools/csharp2vir/PracticalDomain.cs",
        "csharp-tools/csharp2vir/PracticalNumeric.cs",
        "csharp-tools/csharp2vir/PracticalStrings.cs",
        "csharp-tools/csharp2vir/PracticalStructural.cs",
        "csharp-tools/csharp2vir/PracticalSyntaxNormalization.cs",
        "develop/migrations/csharp-03/domain/domain-runtime.json",
        "develop/probes/csharp-03/FoundationDataProbe.cs",
    ]
    if len(records) != len(expected_paths):
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_DOMAIN_INPUTS")
    for untyped, expected_path in zip(records, expected_paths):
...
def load_domain_inputs() -> dict[str, object]:
    return validate_domain_inputs_value(
        active.strict_json_file(DOMAIN_INPUTS_PATH, canonical_transport=True)
    )


def validate_business_inputs_value(value: object) -> dict[str, object]:
    manifest = active.exact_keys(value, {"files", "schema", "work_item"})
    if (
        active.text(manifest["schema"]) != BUSINESS_INPUTS_SCHEMA
        or active.text(manifest["work_item"]) != "CSHARP-03-T03-W13"
    ):
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_BUSINESS_INPUTS")
    records = active.array(manifest["files"])
    expected_paths = [
        "crates/mpk-cli/tests/csharp_practical_business_harness.cs",
        "csharp-tools/csharp2vir/PracticalArrays.cs",
        "csharp-tools/csharp2vir/PracticalBusiness.cs",
        "csharp-tools/csharp2vir/PracticalCapture.cs",
        "csharp-tools/csharp2vir/PracticalConstruction.cs",
        "csharp-tools/csharp2vir/PracticalDataTypes.cs",
        "csharp-tools/csharp2vir/PracticalDomain.cs",
        ...
        "csharp-tools/csharp2vir/PracticalStructural.cs",
        "csharp-tools/csharp2vir/PracticalSyntaxNormalization.cs",
        "develop/migrations/csharp-03/business/business-runtime.json",
        "develop/probes/csharp-03/FoundationDataProbe.cs",
    ]
    if len(records) != len(expected_paths):
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_BUSINESS_INPUTS")
...
def load_business_inputs() -> dict[str, object]:
    return validate_business_inputs_value(
        active.strict_json_file(BUSINESS_INPUTS_PATH, canonical_transport=True)
    )
...
def test_domain() -> None:
    ...
    for untyped in project_files:
        record = active.exact_keys(untyped, {"path", "sha256", "size_bytes"})
        project_records[active.validate_relative_path(active.text(record["path"]))] = record
    manifest = load_domain_inputs()
    toolchain = active.exact_keys(
        descriptor["toolchain_inputs"], set(descriptor["toolchain_inputs"])
    )
    archives = checked_archives(toolchain)
    with tempfile.TemporaryDirectory(
        prefix="mpk-csharp-practical-domain-test-"
    ) as temporary:
        temporary_root = Path(temporary)
        roots = active.materialize_closure(
            toolchain, archives, temporary_root / "closure"
        ...
        for untyped in active.array(manifest["files"]):
            ...
            copy_bound_file(
                ...
                target,
                record,
                "CSHARP_PRACTICAL_DOMAIN_INPUTS",
            )
            copied[relative] = target

        sdk = roots["dotnet-sdk-linux-x64"]
        compiler = sdk / "sdk/10.0.400/Roslyn/bincore/csc.dll"
        output = work / "csharp2vir-practical-domain-tests.dll"
        arguments = list(active.COMPILER_ARGUMENTS)
        arguments.extend(
            [
                "/out:" + str(output),
                "/main:Mpk.CSharp2Vir.PracticalDomainHarness",
                "/pathmap:" + str(work) + "=/_/csharp-practical-domain",
            ]
        )
        reference_root = roots["microsoft-netcore-app-ref"]
        for untyped in active.array(toolchain["reference_projection"]["inventory"]):
        ...
        arguments.extend(
            [
                ...
                str(copied["develop/probes/csharp-03/FoundationDataProbe.cs"]),
                str(copied["csharp-tools/csharp2vir/PracticalCapture.cs"]),
                str(copied["csharp-tools/csharp2vir/PracticalSyntaxNormalization.cs"]),
                str(copied["csharp-tools/csharp2vir/PracticalDataTypes.cs"]),
                str(copied["csharp-tools/csharp2vir/PracticalConstruction.cs"]),
                str(copied["csharp-tools/csharp2vir/PracticalStructural.cs"]),
                str(copied["crates/mpk-cli/tests/csharp_practical_domain_harness.cs"]),
            ]
        )
        build_environment = active.closed_dotnet_environment(
            sdk, temporary_root / "build-environment"
        ...
        if (
            ...
            raise active.CSharpBuildFailure("CSHARP_PRACTICAL_DOMAIN_TEST_BUILD")
...
def load_loop_lowering_inputs() -> dict[str, object]:
    path = REPOSITORY_ROOT / "develop/migrations/csharp-03/loop-lowering/loop-lowering-inputs.json"
    value = active.strict_json_file(path, canonical_transport=True)
    if set(value) != {"schema", "work_item", "files"} or value["schema"] != "mpk.csharp_practical.t04_w02.loop_lowering_inputs.v1" or value["work_item"] != "CSHARP-03-T04-W02":
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_LOOP_CONTRACT_INPUTS")
    expected = ['crates/mpk-cli/tests/csharp_practical_loop_lowering_harness.cs', 'csharp-tools/csharp2vir/PracticalArrays.cs', 'csharp-tools/csharp2vir/PracticalCapture.cs', 'csharp-tools/csharp2vir/PracticalConstruction.cs', 'csharp-tools/csharp2vir/PracticalDataTypes.cs', 'csharp-tools/csharp2vir/PracticalLoopContracts.cs', 'csharp-tools/csharp2vir/PracticalLoopLowering.cs', 'csharp-tools/csharp2vir/PracticalPatternLowering.cs', 'csharp-tools/csharp2vir/PracticalSequences.cs', 'csharp-tools/csharp2vir/PracticalSyntaxNormalization.cs']
    if [r["path"] for r in value["files"]] != expected:
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_LOOP_CONTRACT_INPUTS")
    for record in value["files"]:
        active.exact_keys(record, {"path", "sha256", "size_bytes"})
...
def load_pattern_lowering_inputs() -> dict[str, object]:
    path = REPOSITORY_ROOT / "develop/migrations/csharp-03/pattern-lowering/pattern-lowering-inputs.json"
    value = active.strict_json_file(path, canonical_transport=True)
    if set(value) != {"schema", "work_item", "files"} or value["schema"] != "mpk.csharp_practical.t04_w03.pattern_lowering_inputs.v1" or value["work_item"] != "CSHARP-03-T04-W03":
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_LOOP_CONTRACT_INPUTS")
    expected = ['crates/mpk-cli/tests/csharp_practical_pattern_lowering_harness.cs', 'csharp-tools/csharp2vir/PracticalArrays.cs', 'csharp-tools/csharp2vir/PracticalCapture.cs', 'csharp-tools/csharp2vir/PracticalConstruction.cs', 'csharp-tools/csharp2vir/PracticalDataTypes.cs', 'csharp-tools/csharp2vir/PracticalLoopContracts.cs', 'csharp-tools/csharp2vir/PracticalLoopLowering.cs', 'csharp-tools/csharp2vir/PracticalPatternLowering.cs', 'csharp-tools/csharp2vir/PracticalSequences.cs', 'csharp-tools/csharp2vir/PracticalSyntaxNormalization.cs']
    if [r["path"] for r in value["files"]] != expected:
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_LOOP_CONTRACT_INPUTS")
    for record in value["files"]:
        active.exact_keys(record, {"path", "sha256", "size_bytes"})
...
def load_handler_lowering_inputs() -> dict[str, object]:
    path = REPOSITORY_ROOT / "develop/migrations/csharp-03/handler-lowering/handler-lowering-inputs.json"
    value = active.strict_json_file(path, canonical_transport=True)
    if set(value) != {"schema", "work_item", "files"} or value["schema"] != "mpk.csharp_practical.t04_w05.handler_lowering_inputs.v1" or value["work_item"] != "CSHARP-03-T04-W05":
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_LOOP_CONTRACT_INPUTS")
    expected = ['crates/mpk-cli/tests/csharp_practical_handler_lowering_harness.cs', 'csharp-tools/csharp2vir/PracticalArrays.cs', 'csharp-tools/csharp2vir/PracticalCapture.cs', 'csharp-tools/csharp2vir/PracticalConstruction.cs', 'csharp-tools/csharp2vir/PracticalDataTypes.cs', 'csharp-tools/csharp2vir/PracticalLoopContracts.cs', 'csharp-tools/csharp2vir/PracticalLoopLowering.cs', 'csharp-tools/csharp2vir/PracticalPatternLowering.cs', 'csharp-tools/csharp2vir/PracticalSequences.cs', 'csharp-tools/csharp2vir/PracticalSyntaxNormalization.cs']
    if [r["path"] for r in value["files"]] != expected:
        raise active.CSharpBuildFailure("CSHARP_PRACTICAL_LOOP_CONTRACT_INPUTS")
    for record in value["files"]:
        active.exact_keys(record, {"path", "sha256", "size_bytes"})
...
def test_business() -> None:
    ...
    for untyped in project_files:
        record = active.exact_keys(untyped, {"path", "sha256", "size_bytes"})
        project_records[active.validate_relative_path(active.text(record["path"]))] = record
    manifest = load_business_inputs()
    toolchain = active.exact_keys(
        descriptor["toolchain_inputs"], set(descriptor["toolchain_inputs"])
    )
    archives = checked_archives(toolchain)
    with tempfile.TemporaryDirectory(
        prefix="mpk-csharp-practical-business-test-"
    ) as temporary:
        temporary_root = Path(temporary)
        roots = active.materialize_closure(
            toolchain, archives, temporary_root / "closure"
        ...
        for untyped in active.array(manifest["files"]):
            ...
            copy_bound_file(
                ...
                target,
                record,
                "CSHARP_PRACTICAL_BUSINESS_INPUTS",
            )
            copied[relative] = target

        sdk = roots["dotnet-sdk-linux-x64"]
        compiler = sdk / "sdk/10.0.400/Roslyn/bincore/csc.dll"
        output = work / "csharp2vir-practical-business-tests.dll"
        arguments = list(active.COMPILER_ARGUMENTS)
        arguments.extend(
            [
                "/out:" + str(output),
                "/main:Mpk.CSharp2Vir.PracticalBusinessHarness",
                "/pathmap:" + str(work) + "=/_/csharp-practical-business",
            ]
        )
        reference_root = roots["microsoft-netcore-app-ref"]
        for untyped in active.array(toolchain["reference_projection"]["inventory"]):
        ...
        arguments.extend(
            [
                ...
                str(copied["csharp-tools/csharp2vir/PracticalConstruction.cs"]),
                str(copied["csharp-tools/csharp2vir/PracticalStructural.cs"]),
                str(copied["crates/mpk-cli/tests/csharp_practical_business_harness.cs"]),
            ]
        )
        build_environment = active.closed_dotnet_environment(
            sdk, temporary_root / "build-environment"
        ...
        if (
            ...
            raise active.CSharpBuildFailure("CSHARP_PRACTICAL_BUSINESS_TEST_BUILD")
...
def self_test() -> None:
    ...
    changed["files"].pop()
    expect_rejected(lambda: validate_numeric_inputs_value(changed))
    domain_inputs = load_domain_inputs()
    for key, replacement in (("sha256", "0" * 64), ("size_bytes", 0), ("path", "README.md")):
        changed = deep_copy(domain_inputs)
        changed["files"][0][key] = replacement
        expect_rejected(lambda: validate_domain_inputs_value(changed))
    changed = deep_copy(domain_inputs)
    changed["files"].pop()
    expect_rejected(lambda: validate_domain_inputs_value(changed))
    ...
    for key, replacement in (("sha256", "0" * 64), ("size_bytes", 0), ("path", "README.md")):
        ...
        changed["files"][0][key] = replacement
        expect_rejected(lambda: validate_business_inputs_value(changed))
    changed = deep_copy(business_inputs)
    changed["files"].pop()
    expect_rejected(lambda: validate_business_inputs_value(changed))
...
def main(argv: list[str]) -> int:
    try:
        if argv == ["check-build-inputs"]:
            ...
            sys.stdout.buffer.write(test_loop_contracts(lowering=True))
