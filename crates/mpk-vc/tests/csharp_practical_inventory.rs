...
const POST_FREEZE_IMPLEMENTATION_PATHS: [&str; 30] = [
    ...
    "scripts/build-csharp-practical-frontend.sh",
    "scripts/csharp_practical_build_inputs.py",
];
...
fn csharp_03_t01_w01_ledger_has_one_owner_and_status_per_work_item() {
    ...
    for (work_item, row) in &rows {
        ...
        let expected_status = match work_item.as_str() {
            ...
            | "CSHARP-03-T03-W12" | "CSHARP-03-T03-W13" | "CSHARP-03-T03-W14"
            | "CSHARP-03-T04-W01" | "CSHARP-03-T04-W02" | "CSHARP-03-T04-W03"
            | "CSHARP-03-T04-W04" | "CSHARP-03-T04-W05" | "CSHARP-03-T04-W06"
            | "CSHARP-03-T05-W01" | "CSHARP-03-T05-W02" | "CSHARP-03-T05-W03"
            | "CSHARP-03-T05-W04" | "CSHARP-03-T05-W05" | "CSHARP-03-T05-W06"
            | "CSHARP-03-T06-W01" | "CSHARP-03-T06-W02" | "CSHARP-03-T06-W03"
            | "CSHARP-03-T06-W04" | "CSHARP-03-T06-W05" | "CSHARP-03-T06-W06" => "Complete",
            "CSHARP-03-T06-W07" => "Ready",
            _ => "Blocked",
        };
        ...
        let expected_commit = match work_item.as_str() {
            ...
            "CSHARP-03-T03-W02" => "773591e4ef0900eca84724a15be2d785449c51ad",
            "CSHARP-03-T03-W03" => "d96594ad4cf3db973d04fb4057784d2356de358d",
            "CSHARP-03-T03-W04" => "ba7223fe8238e47703c8da983aa6ba3d8fa73526",
            ...
            "CSHARP-03-T03-W09" => "6714e88e963fba6f06c050989072a2cedfeefedd",
            ...
            "CSHARP-03-T03-W14" => "5e2979c162e01a1e6b1e006aec4c5d9f566384ee",
            "CSHARP-03-T04-W01" => "16946c6ae2a82004be03f49ba52726001dd3317f",
            "CSHARP-03-T04-W02" => "4c4030235fdb5f82aa3fc5b3df2b40727ab0b21e",
            "CSHARP-03-T04-W03" => "25c8a80b2fe59dc4400898f9a6f480dfd749be3e",
            "CSHARP-03-T04-W04" => "80ac614043395370fb733d9c4ddc67a220e7a4a4",
            "CSHARP-03-T04-W05" => "a2521cd71ef6f713d2f216ddbb579415ea44c1f1",
            "CSHARP-03-T04-W06" => "c6549dd0ba8f7c91e383ea22b3fd7b2c8bc3992b",
            "CSHARP-03-T05-W01" => "b0c9a5d5a9616e107200731f62a5abac91828538",
            "CSHARP-03-T05-W02" => "f8ec3c6b036908eccf02e4782a5f68a0e2855822",
            "CSHARP-03-T05-W03" => "9aa555a6d88ea55cd4e2dc41940059746dd968bf",
            "CSHARP-03-T05-W04" => "33b95cd59817b4bbc330a66971e35c2e092cd92e",
            "CSHARP-03-T05-W05" => "40cf7d0c182bf786dad82565f105537cdae6c5b7",
            "CSHARP-03-T05-W06" => "4a8cec4ce746ac65db745480ad76b6b174d67fe5",
            "CSHARP-03-T06-W01" => "d875314cf1d51add12313017ee922b963f485396",
            "CSHARP-03-T06-W02" => "781ebe3ba614b0ad1a21ea62c3ad031352a89dd3",
            "CSHARP-03-T06-W03" => "b605e2b1a7abca43ca0e8b15a8f1eb14a9d37d82",
            "CSHARP-03-T06-W04" => "5d0aec77ffbc42fda871edacc654d4531582fddd",
            "CSHARP-03-T06-W05" => "470cccc75eb64af381547e0e91886375a7f65b36",
            "CSHARP-03-T06-W06" => "SELF",
            _ => "—",
        };
        assert_eq!(
    ...
    for required in [
        ...
        "19 descriptor, 57 specialization, and 12 shared limit vectors",
        ...
        "strict, Rustdoc-hidden `mpk.vir.v2` importer",
        "foundation bytes and content hash",
        "normal-successor edge before it becomes available",
        "handler-entry node defines exactly one typed",
        "bounded parser fuzz seeds",
        "First-pass review findings: `12`",
        ...
        "develop/migrations/csharp-03/domain/domain-inputs.json",
        "## 33. CSHARP-03-T03-W11 completion record",
        "T03-W12 is the sole ready item.",
        "develop/migrations/csharp-03/numeric/numeric-inputs.json",
        "## 32. CSHARP-03-T03-W10 completion record",
        "T03-W11 is the sole ready item.",
        "develop/migrations/csharp-03/codecs/codecs-inputs.json",
        ...
        "develop/migrations/csharp-03/arrays/arrays-inputs.json",
        "T03-W07 is the sole ready item.",
        "## 27. CSHARP-03-T03-W05 completion record",
        "develop/migrations/csharp-03/initialization/initialization-inputs.json",
        "T03-W06 is the sole ready item.",
        "## 26. CSHARP-03-T03-W04 completion record",
        "develop/migrations/csharp-03/construction/construction-inputs.json",
        "T03-W05 is the sole ready item.",
        "## 25. CSHARP-03-T03-W03 completion record",
        "develop/migrations/csharp-03/types/types-inputs.json",
...
fn historical_inventory_exclusions() -> BTreeSet<String> {
    ...
    actual
        .into_iter()
        .chain(POST_FREEZE_IMPLEMENTATION_PATHS.map(str::to_owned))
        .collect()
}
