...
///
/// This model deliberately lives alongside the retired GIR model above until
/// the atomic release cutover. There is no conversion from a GIR document.
#[derive(Clone, Debug, Eq, PartialEq, Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
...
/// Exact expression-term union at the VC boundary. The retired `result`
