...
use mpk_cli::successor_policy::{run_staged_successor_policy, SuccessorPolicySource};
...
pub(super) const CSHARP_CONTRACT: &[u8] = include_bytes!(
...
pub(super) struct NamedPolicyRun {
    ...
    pub run: mpk_cli::successor_policy::StagedSuccessorPolicyRun,
}
