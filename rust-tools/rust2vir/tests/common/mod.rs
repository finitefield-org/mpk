...
fn arguments(
    ...
    [
        ...
        rust2vir_internal::successor::PROFILE_REGISTRY_ID.to_owned(),
        "--profile-registry-revision".to_owned(),
        rust2vir_internal::successor::PROFILE_REGISTRY_REVISION.to_string(),
        "--profile-registry-sha256".to_owned(),
        rust2vir_internal::successor::PROFILE_REGISTRY_SHA256.to_owned(),
        "--profile-entry-sha256".to_owned(),
        rust2vir_internal::successor::PROFILE_ENTRY_SHA256.to_owned(),
        ...
        "mpk.release.registry.v1".to_owned(),
